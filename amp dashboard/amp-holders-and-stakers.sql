  ...
  unranked_table AS (
    SELECT
      ...
      CASE
        ...
        WHEN holder = 0x0d0707963952f2fba59dd06f2b425ace40b492fe THEN 'Gate Dep: 0x0d0707963952f2fba59dd06f2b425ace40b492fe'
        WHEN holder = 0x88fe56808aac806336a0eb28682d10033c73826a THEN 'Amplified Dreams: Deployer'
        ...
        WHEN holder = 0xe1c89a8d9ca1d078de3b6a9e0ed216db1b8b8587 THEN 'immutablevalue.eth'
        ...
        WHEN holder = 0x0c97305bd07fc582bcc2042b9a2dedd9f451e75b THEN 'Binance Dep: 0x0c97305bd07FC582Bcc2042B9a2Dedd9f451E75B'
        WHEN holder = 0x167a9333bf582556f35bd4d16a7e80e191aa6476 THEN 'Coinone 1'
        WHEN holder = 0xe4d3df079fbef6529c893ee4e9298711d480ff35 THEN 'inthecrowd.eth'
        WHEN holder = 0x7f604d597c15b2e2f60dc645844f68b1d781b752 THEN 'Bitstamp 61'
        WHEN holder = 0x333e5827fa75639fb0f529fcbf390821402442aa THEN 'smartymarty.eth'
        WHEN holder = 0x18709e89bd403f470088abdacebe86cc60dda12e THEN 'Huobi: Recovery'
        WHEN holder = 0x8782163068c7cd74d2510768a61135c1e4eb07b3 THEN 'Gate Dep: 0x8782163068c7cd74d2510768a61135c1e4eb07b3'
        ...
        WHEN holder = 0xa94181f3fbc5dc4c74f550b568318227d8a454a0 THEN 'showtheplan.eth'
        WHEN holder = 0x379a27a57d6ae4bbc56f0e8176e8a363ffd61ed3 THEN 'Gate Dep: 0x379a27a57d6ae4bbc56f0e8176e8a363ffd61ed3'
        WHEN holder = 0xf724ae6f9910de897f4cb60354b553ffb7bf27ba THEN 'thequeencity.eth'
